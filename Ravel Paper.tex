...
\newcommand{\Pavane}{\textit{Pavane}}
  ...
  At measure 13, the , the first episode rises over a repeated chords over a pedal point.
  \Autocite{Demuth}
  ...
  To further complicate this matter, Ravel's own piano roll recording in 1922, when analyzed, fluctuates by more than 10bpm, and the dynamics diverges from the printed music \Autocite{Pavane} despite insisting that it should be played calmly without any \textit{rubato}. \Autocite{Demuth}
