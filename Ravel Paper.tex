...
%   \end{itemize}
  ...
  Despite the \textit{Pavane} becoming popular in salons and among amateur pianists, Ravel's own reflections on the are quite harsh and self-critical.
  \Autocite{Roland-Manuel}
  He criticized the piece for showing too much imitation of Chabrier as Fauré's style\Autocite[\textit{Maurice Ravel}, 60]{Larner}, and not much originality.
  \Autocite{Roland-Manuel}
  ...
  \Autocite{Mawer}
  For example, the parallel ninths in the 1899 \textit{Pavane} is quite similar to that found in Debussy's 1896 `Sarabande,' which Ravel later orchestrated in 1922\Autocite[\textit{Maurice Ravel}, 228]{Larner}.
  \Autocite{Mawer}
